...
//  생성자 자동 주입 생략 => 단순히 class의 인스턴스를 불러오는것이 아니라, 등록된 객체(싱글톤)을 불러오는것!
//    @Autowired
...
//    filed type 에러
//    bindingResult.addError(new FieldError("item", "price", item.getPrice(), true, null, null,
//            "가격은 1,000 ~ 1,000,000 까지 허용합니다."));
...
//    @PostMapping("/add")
    public String addItemV5(@ModelAttribute Item item, BindingResult bindingResult, RedirectAttributes redirectAttributes, Model model) {
        ...
        System.out.println("itemValidator = " + itemValidator);
